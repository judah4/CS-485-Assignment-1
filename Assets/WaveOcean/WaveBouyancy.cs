...
{
    public class WaveBouyancy : MonoBehaviour {
    ...
    private ModifyBouyancyMesh modifyBoatMesh;
	...
	void Start() 
	{
        ...
        modifyBoatMesh = new ModifyBouyancyMesh(boatMeshObj, underWaterObj, aboveWaterObj, boatRB);
    ...
    void AddUnderWaterForces()
    {
        ...
        for (int i = 0; i < underWaterTriangleData.Count; i++)
        {
            ...
            //var viscousWaterResistanceForce = BoatPhysicsMath.ViscousWaterResistanceForce(rhoWater, triangleData, Cf);
            //forceToAdd += viscousWaterResistanceForce;
