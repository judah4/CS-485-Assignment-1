...
{
    public class ModifyBouyancyMesh
    {
        ...
        private GameObject underWaterObject;
        ...
        public ModifyBouyancyMesh(GameObject boatObj, GameObject underWaterObj, GameObject aboveWaterObj,
            Rigidbody boatRB)
        {
            //Get the transform
            ...
            underWaterObject = underWaterObj;
